...
import classes_mobs
import math
# reference classes_mobs so static analysis/linting doesn't warn about an unused import
assert classes_mobs is not None
pygame.init()
...
# 
assaiin = Assain("Shadow", "assassin_sprite.png", (64, 64), 400, 300)
...
sprite_paths = {"yambushi_tengu.png", "rabbit.png", "lion": "lion.png", "crow": "crow.png", "butterfly": "butterfly.png"}
