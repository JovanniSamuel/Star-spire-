...
class Forest1(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "ForestMap1.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Forest2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "ForestMap2.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class ForestBoss(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "ForestBossMap.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Castle1(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "CastleMap1.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Castle2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "CastleMap2.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class CastleBoss(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "CastleBossMap.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Swamp1(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "SwampMap1.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Swamp2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "SwampMap2.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class SwampBoss(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "SwampBossMap.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Desert1(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "DesertMap1.jpg"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class Desert2(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "DesertMap2.jpg"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
...
class DesertBoss(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = load_image(os.path.join(Maps_DIR, "DesertBossMap.png"), (WIDTH, HEIGHT))
        self.rect = self.image.get_rect()
        self.rect.x = 0
        self.rect.y = 0
